...
function App() {
  ...
  return (
    ...
    <Card company={element.companyName} datePosted={element.datePosted} post={element.post} tag1={element.tag1} brandLogo={element.brandLogo} pay={element.pay} tag2={element.tag2}></Card>
    </div>
    })}
    </div>
  )
